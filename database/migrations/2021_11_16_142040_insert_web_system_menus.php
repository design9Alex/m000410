...
class InsertWebSystemMenus extends Migration
{
    ...
    protected function insertFooter()
    {
        ...
        DBHelper::insertDistributedData('system_menu', [
            ...
            $id1_2 => [
                'guard' => 'web', 'code' => 'web-footer-abouts-president',
                'title' => '經營者的話', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/president', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 2, 'active' => 1,
            ...
            $id1_3 => [
                'guard' => 'web', 'code' => 'web-footer-abouts-history',
                'title' => '大事紀', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/history', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 3, 'active' => 1,
            ...
            $id1_4 => [
                'guard' => 'web', 'code' => 'web-footer-abouts-organization',
                'title' => '公司組織', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/organization', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 4, 'active' => 1,
            ...
            $id1_5 => [
                'guard' => 'web', 'code' => 'web-footer-abouts-management',
                'title' => '經營團隊', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/management', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 5, 'active' => 1,
            ...
            $id1_6 => [
                'guard' => 'web', 'code' => 'web-footer-abouts-vision',
                'title' => '使命與願景', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/vision', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 6, 'active' => 1,
            ...
            $id1_7 => [
                'guard' => 'web', 'code' => 'web-footer-abouts-awards',
                'title' => '肯定與榮耀', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/awards', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 7, 'active' => 1,
            ...
            $id1_8 => [
                'guard' => 'web', 'code' => 'web-footer-abouts-relationship',
                'title' => '關係企業', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/relationship', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 8, 'active' => 1,
            ...
            $id1_9 => [
                'guard' => 'web', 'code' => 'web-footer-abouts-location',
                'title' => '全球據點', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/location', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 9, 'active' => 1,
    ...
    protected function insertSitemap()
    {
        ...
        DBHelper::insertDistributedData('system_menu', [
            ...
            $id1_2 => [
                'guard' => 'web', 'code' => 'web-sitemap-abouts-president',
                'title' => '經營者的話', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/president', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 2, 'active' => 1,
            ...
            $id1_3 => [
                'guard' => 'web', 'code' => 'web-sitemap-abouts-history',
                'title' => '大事紀', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/history', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 3, 'active' => 1,
            ...
            $id1_4 => [
                'guard' => 'web', 'code' => 'web-sitemap-abouts-organization',
                'title' => '公司組織', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/organization', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 4, 'active' => 1,
            ...
            $id1_5 => [
                'guard' => 'web', 'code' => 'web-sitemap-abouts-management',
                'title' => '經營團隊', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/management', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 5, 'active' => 1,
            ...
            $id1_6 => [
                'guard' => 'web', 'code' => 'web-sitemap-abouts-vision',
                'title' => '使命與願景', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/vision', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 6, 'active' => 1,
            ...
            $id1_7 => [
                'guard' => 'web', 'code' => 'web-sitemap-abouts-awards',
                'title' => '肯定與榮耀', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/awards', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 7, 'active' => 1,
            ...
            $id1_8 => [
                'guard' => 'web', 'code' => 'web-sitemap-abouts-relationship',
                'title' => '關係企業', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/relationship', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 8, 'active' => 1,
            ...
            $id1_9 => [
                'guard' => 'web', 'code' => 'web-sitemap-abouts-location',
                'title' => '全球據點', 'description' => null, 'editor' => null, 'pic' => null,
                'url' =>  '/location', 'target' => '_self',
                'permission' => null, 'roles' => null, 'options' => null,
                'operations' => null, 'sort' => 9, 'active' => 1,
