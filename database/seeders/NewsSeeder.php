...
class NewsSeeder extends Seeder
{
    ...
    protected function insertArticleColumn()
    {
        ...
        DB::table('article_column')->insert($insertData = [
            ['id' => 'news-default', 'created_at' => $timestamp, 'updated_at' => $timestamp],
        ]);
    ...
    protected function insertArticleCategory()
    {
        ...
        DB::table('article_category')->insert($insertData = [
            ['id' => 'web-news', 'parent_id' => 'article-post',
                'created_at' => $timestamp, 'updated_at' => $timestamp],

            ['id' => 'web-news-news', 'parent_id' => 'web-news',
                'created_at' => $timestamp, 'updated_at' => $timestamp],
            ['id' => 'web-news-activity', 'parent_id' => 'web-news',
                'created_at' => $timestamp, 'updated_at' => $timestamp],
        ...
        DBHelper::insertDistributedData('article_category', [
            'web-news' => [
                ...
                'path' => null,
                'column_config' => 'news-default',
                'category_page' => 'web-news',
                'article_page' => 'web-news-post',
...
HTML;
    ...
    protected function insertTemplate()
    {
        ...
        DB::table('template')->insert($insertData = [
            ['id' => $id1 = 'editor-news-post', 'created_at' => $timestamp, 'updated_at' => $timestamp],
        ]);
