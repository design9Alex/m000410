<?php
/**
 * Page route:financial-law-conference
 *
 * @var string $local
 */
?>
    ...
    <section class="MainBox editor">
      ...
      <div class="TabBox financial" data-aos="zoom-in" data-aos-duration="1000">
        <div class="TabNow d-lg-none jsTabNow">
          <div class="TabNowText">法說會資料</div>
      ...
      <h3 class="Para1" data-aos="fade-up" data-aos-duration="1000">法說會資料</h3>

      @include('web.templates.modules.financial-law-conference')
