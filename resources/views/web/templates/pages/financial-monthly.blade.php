    ...
    <section class="MainBox editor">
      ...
      <div class="TabBox financial" data-aos="zoom-in" data-aos-duration="1000">
        <div class="TabNow d-lg-none jsTabNow">
          <div class="TabNowText">每月營收報告</div>
      ...
      <h3 class="Para1" data-aos="fade-up" data-aos-duration="1000">每月營收報告</h3>
      @include('web.templates.modules.financial-monthly')
