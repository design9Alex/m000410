  ...
  <div class="OuterBox">
    <section class="MainBox editor">
      ...
      <div class="hstyImg" data-aos="zoom-in" data-aos-duration="1500">
        <img data-src="/static/web/styles/images/about/history/top0.webp" src="/static/web/styles/images/about/history/top0.webp" class="defaultImg lazyload" alt="">
      </div>


      @include('web.templates.modules.about-history-list')
