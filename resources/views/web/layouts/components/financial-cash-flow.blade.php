...
<div class="fnclrptChartBox jsFnclrptChart" data-when="{{$type}}" data-kind="cash_flow" data-aos="fade-up" data-aos-duration="1000">
  ...
  <table>
    ...
    @if($type == 'quarter')
      @foreach($tableQuarter as $key => $item)
        <tr class="">
          <td class="title text-start fontWeight500 ">{{__('web.cash_flow.'.$key)}}</td>
