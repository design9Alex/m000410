<template>
  <base-edit :urls="urls" :configs="configs" ref="baseEdit">
...
import BaseEdit from "../../Components/Layout/BaseEdit";
...
export default {
  ...
  computed: {
    baseEdit: {
      get: function () {
        if (this.$refs.baseEdit) {
          return this.$refs.baseEdit;
        }
    ...
    trans: {
      get: function () {
        if (this.baseEdit.trans) {
          return this.baseEdit.trans;
        }
        return {};
      },
      cache: false
