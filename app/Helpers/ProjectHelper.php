...
function breadcrumbs($route, $parameters = [])
{
    ...
    switch($route){
        ...
        case 'web.page.web-financial-monthly':
            $breadcrumbs[] = ['uri' => route('web.page.web-financial') , 'title' => trans('web.menu.investor')];
            ...
            $menu = \Minmax\Base\Models\SystemMenu::query()
                ...
                ->distributedWhere('code','web-header-investor-financial-monthly')
                ->distributedActive()
                ->first();
        ...
        case 'web.page.web-financial-quarterly-statements':
            $breadcrumbs[] = ['uri' => route('web.page.web-financial') , 'title' => trans('web.menu.investor')];
            ...
            $menu = \Minmax\Base\Models\SystemMenu::query()
                ...
                ->distributedWhere('code','web-header-investor-financial-quarterly-statements')
                ->distributedActive()
                ->first();
        ...
        case 'web.page.web-financial-annual':
            $breadcrumbs[] = ['uri' => route('web.page.web-financial') , 'title' => trans('web.menu.investor')];
            ...
            $menu = \Minmax\Base\Models\SystemMenu::query()
                ...
                ->distributedWhere('code','web-header-investor-financial-annual')
                ->distributedActive()
                ->first();
        ...
        case 'web.page.web-financial-law-conference':
            $breadcrumbs[] = ['uri' => route('web.page.web-financial') , 'title' => trans('web.menu.investor')];
            ...
            $menu = \Minmax\Base\Models\SystemMenu::query()
                ...
                ->distributedWhere('code','web-header-investor-financial-law-conference')
                ->distributedActive()
                ->first();
