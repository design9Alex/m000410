...
return [
    ...
    */
    ...
    'configRepository' => \Alexusmai\LaravelFileManager\Services\ConfigService\DefaultConfigRepository::class,
    ...
    */
    ...
    'aclRepository' => \Minmax\Base\Admin\FileManagerACLRepository::class,
    ...
    |
    | !!! WARNING !!!
    | If you change it, you should compile frontend with new prefix(baseUrl)
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Image resize config - only used when image file upload.
    |--------------------------------------------------------------------------
    |
    | 'maxWidth'    =>  An integer number (pixel)
    | 'maxHeight'   =>  An integer number (pixel)
    |
    */
    'resize' => [
