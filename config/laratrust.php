...
return [
    ...
    */
    'user_models' => [
        'admin' => \Minmax\Base\Models\AdminUser::class,
        // 'web' => \Minmax\Member\Models\MemberUser::class,
    ],
    ...
    */
    'models' => [
        ...
        'role' => \Minmax\Base\Models\Role::class,

        'permission' => \Minmax\Base\Models\Permission::class,
